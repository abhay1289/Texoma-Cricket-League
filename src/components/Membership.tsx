...
const PricingCard: React.FC<{ tier: PricingTier; index: number }> = ({ tier, index }) => (
    <div className={`relative bg-white rounded-xl sm:rounded-2xl p-8 flex flex-col transition-all duration-500 hover:shadow-super group overflow-hidden ${tier.isPremium
    ...
    >
        ...
        <div className="mb-6 sm:mb-8">
            <span className="font-heading text-xs tracking-widest text-secondary font-semibold uppercase mb-2 sm:mb-3 block">Level {tier.id}</span>
            ...
            <div className="flex items-baseline gap-1.5 sm:gap-2">
                ...
                <span className="text-text-dark/50 font-heading text-xs tracking-widest uppercase">{tier.period}</span>
            </div>
        </div>
        ...
        <section id="membership" className="py-[var(--section-py)] md:py-[var(--section-py-lg)] bg-bg-light relative overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
                    <div className="inline-flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-primary/5 bg-white/60">
                        <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-secondary" />
                        <span className="font-heading tracking-widest text-primary text-xs font-semibold uppercase">Membership</span>
                    </div>
